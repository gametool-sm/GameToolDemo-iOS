...
@implementation SUNYSAGzipUtility
...
+(NSData*) gzipData: (NSData*)pUncompressedData
{
    ...
    {
        SUNYSALog(@" Error: Can't compress an empty or null NSData object.");
        return nil;
    }
    ...
    do {
        ...
        if (initError != Z_OK)
        {
            ...
            SUNYSALog(@"deflateInit2() Error: \"%@\" Message: \"%s\"", errorMsg, zlibStreamStruct.msg);
            return nil;
        }
        ...
        if (deflateStatus != Z_STREAM_END) {
            ...
            SUNYSALog(@"zlib error while attempting compression: \"%@\" Message: \"%s\"", errorMsg, zlibStreamStruct.msg);
