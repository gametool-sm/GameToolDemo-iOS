//
//  GTClickerPointSetViewController.h
//  GTSDK
//
...
@interface GTClickerPointSetViewController : GTBaseViewController
...
@property (nonatomic, strong) GTClickerPointSetPlanView *planView;//要向下滑所以用ScrollView
